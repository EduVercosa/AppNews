...
fun getSourceListMock(): SourceList {
    val listType = object : TypeToken<List<SourceList>>() {}.getType()
    return Gson().fromJson<SourceList>(getSourceJsonResponseMock(), listType)
}

fun getSourceJsonResponseMock() = """{
	"sources": [{
		"id": "abc-news",
		"name": "ABC News",
